...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6ScxmlQmlTargetsPrecheck.cmake")

if(NOT __qt_ScxmlQml_skip_include_targets_file AND Qt6ScxmlQml_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6ScxmlQmlExtraProperties.cmake"
        OPTIONAL)
    set(__qt_ScxmlQml_targets_file_included ON)
endif()
...
if (Qt6ScxmlQml_FOUND
    ...
    find_package(Qt6ScxmlQmlPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_ScxmlQml_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::ScxmlQml)
    ...
    if(NOT DEFINED Qt6ScxmlQml_NOT_FOUND_MESSAGE)
        ...
        if(__qt_ScxmlQml_skip_include_targets_file)
            string(APPEND Qt6ScxmlQml_NOT_FOUND_MESSAGE
                "Possibly due to __qt_ScxmlQml_skip_include_targets_file being set to TRUE and thus "
