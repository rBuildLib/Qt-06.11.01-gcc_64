...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6StateMachineQmlTargetsPrecheck.cmake")

if(NOT __qt_StateMachineQml_skip_include_targets_file AND Qt6StateMachineQml_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6StateMachineQmlExtraProperties.cmake"
        OPTIONAL)
    set(__qt_StateMachineQml_targets_file_included ON)
endif()
...
if (Qt6StateMachineQml_FOUND
    ...
    find_package(Qt6StateMachineQmlPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_StateMachineQml_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::StateMachineQml)
    ...
    if(NOT DEFINED Qt6StateMachineQml_NOT_FOUND_MESSAGE)
        ...
        if(__qt_StateMachineQml_skip_include_targets_file)
            string(APPEND Qt6StateMachineQml_NOT_FOUND_MESSAGE
                "Possibly due to __qt_StateMachineQml_skip_include_targets_file being set to TRUE and thus "
