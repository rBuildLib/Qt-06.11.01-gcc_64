...
get_target_property(_qt_imported_soname Qt6::StateMachine IMPORTED_SONAME_RELWITHDEBINFO)
...
if(_qt_imported_soname)
    set_property(TARGET Qt6::StateMachine PROPERTY IMPORTED_SONAME_RELEASE "${_qt_imported_soname}")
endif()
