...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6SerialBusTargetsPrecheck.cmake")

if(NOT __qt_SerialBus_skip_include_targets_file AND Qt6SerialBus_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6SerialBusExtraProperties.cmake"
        OPTIONAL)
    set(__qt_SerialBus_targets_file_included ON)
endif()
...
if (Qt6SerialBus_FOUND
    ...
    find_package(Qt6SerialBusPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_SerialBus_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::SerialBus)
    ...
    if(NOT DEFINED Qt6SerialBus_NOT_FOUND_MESSAGE)
        ...
        if(__qt_SerialBus_skip_include_targets_file)
            string(APPEND Qt6SerialBus_NOT_FOUND_MESSAGE
                "Possibly due to __qt_SerialBus_skip_include_targets_file being set to TRUE and thus "
